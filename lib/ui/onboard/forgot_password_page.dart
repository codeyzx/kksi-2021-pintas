...
class _ForgotPasswordState extends State<ForgotPassword> {
      ...
      child: RaisedButton(
        ...
        child: Ink(
          decoration: BoxDecoration(
              gradient: LinearGradient(colors: [HexColor("#3a7bd5"), HexColor("#468df0")],
                  ...
                  child: ListView(
                    children: [
                      ...
                      children: <Widget> [
                        ...
                        Container(
                          child: Text(
                            "Silakan masukkan alamat email dari akun PINTAS Anda untuk mendapatkan email berisi Link Reset Kata Sandi ",
                            style: TextStyle(
                              fontSize: 14.sp,
                        ...
                        Padding(
                          ...
                          child: _loading
                              ? loadIndicator : Container(child: next,
                          ),
                        ),
  ...
  snackBarUnSuccesful() {
    return SnackBar(
      content: Text(
        "Tidak ada pengguna PINTAS di akun ini!",
        style: TextStyle(color: Colors.white),
      ),
